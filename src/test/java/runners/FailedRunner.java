...
@CucumberOptions(
        ...
        //we provide the path of packages to get all the step definitions
        glue= "steps",
        ...
        //to execute scripts in real time, we should se this value to false
        dryRun = false,
        ...
        //use or if we need to execute scenarios from logical or keyword which will execute either of the scenario having the tag
        //use and if we need to execute scenarios from logical and keyword which will execute the scenarios having both the tags in it
